...
class VWAP(object):
    ...
    def push_tick(self, nano, cum_volume):
        ...
        if sec_time < 0:
            ...
            if self._last_update + 2 < self._n_interval:
            #     warnings.warn('Over %d secs without receiving data' % self._interval)
...
if __name__ == "__main__":
    ...
    today_for_test = '20180111'

    Tracey = VWAP_handler(interval, ['SZE000001'], data_path = '/shared/kungfu/data/', lasso_lambda = 812314)

    a = Tracey.tickers['SZE000001']

    df = pd.read_csv(a.DATA_PATH + "20180111/SZE000001.csv")
